...
import 'package:todo_frontend/api/lib/src/api_util.dart';
...
class AuthenticationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GenericResponseString] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseString>> changePassword({ 
    ...
    GenericResponseString? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GenericResponseString),
      ) as GenericResponseString;
    ...
    return Response<GenericResponseString>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponseString] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseString>> confirmUser({ 
    required String code,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/auth/confirm';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseLoginResponse>> login({ 
    ...
    GenericResponseLoginResponse? _responseData;
    ...
    return Response<GenericResponseLoginResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponseString] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseString>> logout({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GenericResponseOutput] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseOutput>> register({ 
    ...
    GenericResponseOutput? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GenericResponseOutput),
      ) as GenericResponseOutput;
    ...
    return Response<GenericResponseOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponseString] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseString>> resetPassword({ 
